...
import { Box, Button, Input, Flex, Text, Card, CardBody } from '@chakra-ui/react';
  ...
  return (
    <Box>
       <Flex justifyContent='center' mt={4} gap={4}>
        <Text textAlign="center" fontSize="3xl" color='#A52A2A' fontWeight="900">
          Welcome, Redeem your Gift Card today!!!
        </Text>
      </Flex>
    
      <Flex justifyContent='center' mt={100} >
        <Card h='300px'  rounded='lg' p={5}
      borderWidth="1px"
      borderRadius="lg"
      boxShadow="0 4px 20px rgba(0, 0, 0, 0.5)" w='850px' height="21rem">
          <CardBody>
            <Text as='h2' color='black' fontWeight={700} fontSize={25}>Enter Your Gift Card Code Here</Text>
